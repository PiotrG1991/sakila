...
with cnx:
    ...
    #     print(error)
    # try:
    #     cursor.execute(query_insert_user_tb, ('Roman', 'a@a2.pl', 'michal_dworczyk2024'))
    # except DatabaseError as error:
    #     print(error)
    # try:
    #     cursor.execute(query_update_user_tb, ('topSecretMateusz2024', 1))
    # except DatabaseError as error:
    #     print(error)
    # try:
